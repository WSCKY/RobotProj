/**
  ...
  *          EEPROM memory mounted on Navigation board.
  *          
  *          ===================================================================      
...
static void sEE_LowLevel_DeInit(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = INT_PRIORITY_SEE_IIC_DMA_TX;
  ...
  NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = INT_PRIORITY_SEE_IIC_DMA_RX;
  NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0x0;
  NVIC_Init(&NVIC_InitStructure);
...
{ 
  ...
  /*!< depending on the sEE Address selected in the AT24CXX.h file */
