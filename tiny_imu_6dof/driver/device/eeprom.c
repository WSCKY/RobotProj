/**
  ...
  * @brief   This file provides a set of functions needed to manage an I2C
  *          EEPROM memory.
  *          
  *          ===================================================================
  *          Notes:
  ...
  *          GPIO) are defined in ifconfig.h file, and the initialization is
  *          performed in sEE_LowLevel_Init() function declared in i2c1.c
  *          file.
